        ...
        >
          ...
          <div class="px-6 py-4">
            ...
            <p class="text-gray-700 text-base">
              ...
              16-megapixel camera and 8gb ram. Running Gas 2.0.
            </p>
        ...
        >
          ...
          <div class="px-6 py-4">
            ...
            <p class="text-gray-700 text-base">
              ...
              20-megapixel camera, 168gb storage, and 8gb ram. Running Gas 2.0.
            </p>
        ...
        >
          ...
          <div class="px-6 py-4">
            ...
            <p class="text-gray-700 text-base">
              ...
              48-megapixel camera, 168gb storage, and 8gb ram. Running Gas 2.0.
            </p>
            <p class="text-gray-700 text-base mt-2">Price: $1999</p>
            <div class="flex items-center mt-4">
              <button
